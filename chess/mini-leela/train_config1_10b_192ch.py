"""
Configuration 1: 10 blocks, 192 channels
Expected: ~6-7M parameters
...
print("="*70)
print("CONFIG 1: 10 ResNet blocks, 192 channels")
print("="*70)
print("\nExpected: ~6-7M parameters")
...
for epoch in range(1, num_epochs + 1):
    ...
    # Save best model
    if status:
        model_path = f"config1_10b_192ch_best_{timestamp}.pth"
        torch.save({
...
print("\n" + "="*70)
print("RESULTS - CONFIG 1 (10 blocks, 192 channels)")
print("="*70)
print(f"Best Test Accuracy: {best_test_acc*100:.2f}% at epoch {best_test_epoch}")
